...
export function HomeHero() {
    return (
        <section className="bg-cover min-h-screen bg-no-repeat justify-center  w-full"
                 style={{
                     backgroundImage: 'linear-gradient(to bottom, rgba(0, 0, 0, 1), rgba(0, 0, 0, 0.5), rgba(0, 10, 0, 0.9)), url("/posters/mission.jpg")',
                     backgroundPosition: 'top',
                 }}
        >
            <div className="mx-auto">
                <TopNav/>
                <div className="container mt-32 px-8 md:px-24 w-full text-white  2xl:w-1/2">
                    <div className="flex flex-col gap-3">
                        <h1 className={`text-3xl lg:text-7xl font-bold ${quando.className}`}>
                        ...
                        <p className="text-sm py-4 text-gray-100 tracking-wide lg:leading-loose lg:text-lg">
                            Geralt of Rivia, a mutated monster-hunter for hire, journeys toward his destiny in a
                            turbulent
                            world
                            where people often prove more wicked than beasts.
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. A, ad aliquid amet aperiam
                            distinctio
                            ex
